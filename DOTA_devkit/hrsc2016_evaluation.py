...
def parse_args():
    ...
    parser.add_argument('--det_root', default='./work_dirs/IOUfit_ReDet_re50_refpn_3x_hrsc2016_1')
...
def main(args):
    ...
    detpath = args.det_root+'/Task1_results/Task1_ship.txt'
    annopath = r'/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/HRSC2016/Test/labelTxt/{:s}.txt'  # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/HRSC2016/ImageSets/test.txt'
