...
class OSRboxSingleRoIExtractor(nn.Module):
    ...
    def __init__(self,
                 ...
                 w_enlarge=1.2,
                 h_enlarge=1.4):
        super(OSRboxSingleRoIExtractor, self).__init__()
    ...
    def forward(self, feats, rois):
        ...
        if isinstance(out_size, int):
            roi_feats_cls = torch.cuda.FloatTensor(rois.size()[0], self.out_channels,
                                               out_size, out_size).fill_(0)
            roi_feats_reg = torch.cuda.FloatTensor(rois.size()[0], self.out_channels,
                                               out_size, out_size).fill_(0)
