...
from ..rbbox_heads import OSBBoxHeadRbbox
from ..registry import HEADS
from ..utils import ConvModule


@HEADS.register_module
class OSConvFCBBoxHeadRbbox(OSBBoxHeadRbbox):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(OSConvFCBBoxHeadRbbox, self).__init__(*args, **kwargs)
    ...
    def init_weights(self):
        super(OSConvFCBBoxHeadRbbox, self).init_weights()
...
@HEADS.register_module
class OSSharedFCBBoxHeadRbbox(OSConvFCBBoxHeadRbbox):

    def __init__(self, num_fcs=2, fc_out_channels=1024, *args, **kwargs):
        assert num_fcs >= 1
        super(OSSharedFCBBoxHeadRbbox, self).__init__(
            num_shared_convs=0,
