...
def parse_args():
    ...
    parser.add_argument('--config', default='/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/projects/ReDet/configs/IOUFit_DOTA/ReDet_re50_refpn_1x_dota1_trainval.py')
    parser.add_argument('--output_path', default='/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/projects/ReDet/work_dirs/ReDet_re50_refpn_1x_dota1_trainval')
...
if __name__ == '__main__':
    ...
    pkl_file = os.path.join(args.output_path, 'results.pkl')
