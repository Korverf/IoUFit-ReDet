...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'dataset_split_1024_gap200/train1024/DOTA_train_1024.json',
        img_prefix=data_root + 'dataset_split_1024_gap200/train1024/images/',
        img_scale=(1024, 1024),
...
log_level = 'INFO'
work_dir = './work_dirs/ReDet_re50_refpn_1x_dota1_train'
load_from = None
resume_from = None
workflow = [('train', 1)]
