...
data = dict(
    ...
    test=dict(
        ...
        test_mode=True))
# optimizer
optimizer = dict(type='SGD', lr=0.005, momentum=0.9, weight_decay=0.0001)#双卡
...
log_level = 'INFO'
work_dir = './work_dirs/rotated_iou_ReDet_re50_refpn_1x_dota1_trainval'
