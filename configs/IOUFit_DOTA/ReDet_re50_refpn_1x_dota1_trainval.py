...
data_root = '/media/yyw/607ca214-10cb-4af6-af97-eac656e135d1/yyw/yyf/Dataset/DOTA-1.0/'
img_norm_cfg = dict(
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'dataset_split_1024_gap200/val1024/DOTA_val_1024.json',
        img_prefix=data_root + 'dataset_split_1024_gap200/val1024/images/',
        img_scale=(1024, 1024),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
...
log_level = 'INFO'
work_dir = './work_dirs/ReDet_re50_refpn_1x_dota1_trainval'
