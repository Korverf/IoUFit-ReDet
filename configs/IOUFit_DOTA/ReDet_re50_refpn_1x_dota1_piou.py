...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_bbox=dict(type='PIoULoss', loss_weight=0.5, img_size=1024)
    ),
    ...
    rbbox_head = dict(
        ...
        loss_cls=dict(
            type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0),
        loss_bbox=dict(type='PIoULoss', loss_weight=1.25, img_size=1024)
    )
    )
...
log_level = 'INFO'
work_dir = './work_dirs/ReDet_re50_refpn_1x_dota1_piou_3'
