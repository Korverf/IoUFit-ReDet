...
model = dict(
    ...
    rbbox_roi_extractor=dict(
        type='OSRboxSingleRoIExtractor',
        roi_layer=dict(type='OSRiRoIAlign', out_size=7, sample_num=2),
        out_channels=256,
        featmap_strides=[4, 8, 16, 32]),
    rbbox_head = dict(
        type='OSSharedFCBBoxHeadRbbox',
        num_fcs=2,
        in_channels=256,
        fc_out_channels=1024,
        roi_feat_size=7,
...
log_level = 'INFO'
work_dir = 'work_dirs/OS_ReDet_re50_refpn_3x_hrsc2016_rerun_2'
